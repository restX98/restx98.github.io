      ...
      <GlassContainer className="snake-box">
        <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
          <div className="mx-auto max-w-screen-sm text-center">
            ...
            <Link
              className="my-4 inline-flex rounded-lg bg-zinc-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-zinc-700 focus:outline-none focus:ring-4 focus:ring-zinc-900"
              href="#"
            >
              Back to Home
            </Link>
